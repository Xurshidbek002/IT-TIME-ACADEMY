...
const About = () => {
  ...
  return (
    <div className="md:px-16 pb-10">
      <div className="container">
        <section classNameName="text-center">
          <div className="about-header text-center">
            <div className="inline-flex mt-35 items-center rounded-[9999px] py-2 px-4 mb-4 text-[10px] md:text-sm bg-[#fee2e2] text-[#991b1b] font-semibold leading-5">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
            ...
            <h1 className="mb-4 text-3xl md:text-5xl leading-10 md:leading-none font-bold text-gray-900">
              {t("aboutUs.title")}
            </h1>
            <p className="mb-8 text-md leading-relaxed text-gray-600">
              {t("aboutUs.subtitle")}
            </p>
            <p className="mx-auto mb-16 max-w-5xl text-[9px]  md:text-[14px]  leading-[1.625] text-gray-700 text-center">
              {t("aboutUs.desc")}
            </p>
          </div>
          {/* about top */}
          <div className="text-start grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-16">
            <div data-aos="fade-left" className="">
              <div className="rounded-xl bg-white p-6 shadow-xl hover:scale-[1.05] scale-none transition-all ease-in-out duration-[1s]">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
            ...
            <div data-aos="fade-left" className="">
              <div className="rounded-xl bg-white p-6 shadow-xl hover:scale-[1.05] scale-none transition-all ease-in-out duration-1000">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
          ...
          <div className="advantages-section my-16 mt-18">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="advantage-card p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-gray-200/20 hover:border-blue-500/50 transition-all">
                ...
                <p className="text-gray-300">
                  Nazariy bilimlar bilan birga amaliy ko'nikmalarni
                  shakllantiramiz
                </p>
              </div>
            </div>
          ...
          <div className="mt-12 rounded-xl bg-white px-5 py-9 shadow-md">
            ...
            <div className="text-start grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-8">
              <div data-aos="fade-left" className="">
                <div className="rounded-xl bg-white p-6 shadow-xl hover:scale-[1.05] scale-none transition-all ease-in-out duration-[1s]">
                  <svg
                    stroke="currentColor"
