...
import { FaPhone, FaSpinner, FaTelegram, FaTelegramPlane } from 'react-icons/fa'
...
function Header() {
  ...
  return (
    <div>
      <div data-aos="fade-in" data-aos-duration="1000" className="fixed w-full z-100">
        ...
        <div className="bg-white py-4 shadow-md">
          <div className="container flex items-center justify-between">
            ...
            <nav className="hidden md:flex gap-4 items-center">
              <NavLink to="/" className="text-[18px] button font-medium text-gray-800">
                {t('header.home')}
              </NavLink>
              <div
                data-aos="fade-up"
              ...
              ></div>
              <NavLink to="/courses" className="text-[18px] button font-medium text-gray-800">
                {t('header.courses')}
              </NavLink>
              <div
                data-aos="fade-up"
              ...
              <NavLink to="/mentors" className="text-[18px] button font-medium text-gray-800">
                {t('header.mentors')}
              </NavLink>
              <div
                data-aos="fade-up"
              ...
              <NavLink to="/about" className="text-[18px] button font-medium text-gray-800">
                {t('header.about')}
              </NavLink>
              <div
                data-aos="fade-up"
              ...
              <NavLink to="/contact" className="text-[18px] button font-medium text-gray-800">
                {t('header.contact')}
              </NavLink>
              <button
                onClick={handleModal}
            ...
            <div className={`flex flex-col gap-[9px] cursor-pointer z-20 md:hidden`} onClick={menu}>
              <div
              ...
              <div className="w-full relative flex flex-col items-center h-screen z-10 bg-white p-5 ">
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="flex gap-4">
                    <a href="https://t.me/egoistmiz" className="text-gray-600 hover:text-red-500">
                      <FaTelegram size={25} />
                    </a>
      ...
      {open && (
        <Modal onClose={handleModal}>
          <div className="bg-white relative h-full max-w-[270px] md:max-w-md mx-auto p-6 rounded-lg shadow-lg overflow-y-auto">
            ...
            <h2 className="text-xl md:text-2xl font-bold mb-2">{t('header.modal.title')}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                disabled={sending}
              >
                {sending ? <FaSpinner className=" animate-spin" /> : t('header.modal.btn')}
              </button>
            </form>
          </div>
        </Modal>
